 ...
 * @author Murat
 */
public class EditTechnicalManager extends javax.swing.JPanel {

    private Team team;
    private JFrame frame;
    
    public EditTechnicalManager(Team otherT) {
        initComponents();
        frame = new JFrame("Edit Technical Manager");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try{
            ...
            TechnicalManager tMngr = new TechnicalManager(surname, name, surname, id, salary, year);
            team.setManager(tMngr);
