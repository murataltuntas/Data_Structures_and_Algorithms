...
public class testPQueue{
    ...
    protected PriorityQueue<Integer> emptyList = new PriorityQueue();
    protected PriorityQueue<Integer> Elements = new PriorityQueue();
    protected PriorityQueue<Integer> newElements = new PriorityQueue();
    protected PriorityQueue<Integer> newElements2 = new PriorityQueue();
    protected PriorityQueue<Integer> newElements3 = new PriorityQueue();
    protected Integer nullInteger = null;
    protected PriorityQueue nullList = null;
